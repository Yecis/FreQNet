...
class FDFTM_ourv2_cross(nn.Module):
    def __init__(self, dim):
        super(FDFTM_ourv2_cross, self).__init__()
        bias = False
    ...
    def forward(self, x):
        ...
        rgb_att_out = ir_fea  + rgb_fea_out
        ir_att_out = rgb_fea  + ir_fea_out
...
class fusion_twov2(nn.Module):
    def __init__(self, dim):
        super().__init__()
        self.FDFTM = FDFTM_ourv2_cross(dim)
